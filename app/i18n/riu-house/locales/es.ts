...
const es: RiuHouseTranslations = {
  fullName: "Riu House at NuvoHauz",
  ...
  stats: {
    ...
    bathrooms: "4 baños",
    sleepsComfortably: "Capacidad cómoda para 6 huéspedes",
    maxGuests: "Máximo 8 huéspedes con aprobación previa",
    introRate: "Desde $250 por noche",
  },
  sections: {
    about: "Sobre Riu House",
    amenities: "Comodidades",
    sleeping: "Distribución de Camas",
    pricing: "Tarifas y Cargos",
    houseRules: "Reglas de la Casa",
    arrival: "Llegada y Transporte",
  },
...
Al aire libre, los huéspedes pueden relajarse entre jardines tropicales, disfrutar de las terrazas cubiertas y usar la piscina compartida con las dos cabañas vecinas de NuvoHauz. Riu House ofrece un entorno tranquilo para quienes buscan comodidad, privacidad y una conexión más cercana con la naturaleza de Costa Rica.`,
  amenities: [
    ...
    "Televisión grande en la sala",
    "Cocina totalmente equipada",
    "Refrigerador",
    "Microondas",
    "Utensilios, vajilla, vasos y cubiertos",
    "Isla de cocina con asientos",
    "Comedor interior",
    "Terrazas y balcones privados",
    "Piscina compartida",
    "Lavadora y secadora compartidas",
    "Ducha exterior",
    "Jardines tropicales",
    "Vistas al río y al paisaje tropical",
  ...
  pricing: [
    "Tarifa introductoria entre semana: $250 por noche",
    "Tarifa introductoria viernes y sábado: $270 por noche",
    "Tarifa de limpieza: $60 por reservación",
    "Ocupación estándar: 6 huéspedes",
    "Ocupación máxima: 8 huéspedes con aprobación previa",
    "Huéspedes 7 y 8: $25 por huésped adicional, por noche",
    "Estancia mínima estándar: 2 noches",
    "Días festivos y períodos pico seleccionados: mínimo de 3 noches",
    "Las reservaciones de una noche no están disponibles a través del sitio web.",
  ],
  houseRules: [
    "Check-in: 3:00 p.m.",
    "Checkout: 11:00 a.m.",
  ...
  arrival:
    "Riu House está ubicada en Paquera, en la Península de Nicoya de Costa Rica. El tiempo de viaje desde el Aeropuerto Internacional Juan Santamaría varía según el tráfico y los horarios del ferry. Los huéspedes que viajan por Puntarenas deben considerar tiempo para el registro, embarque y la travesía de aproximadamente 70 a 80 minutos hasta Paquera.",
  inquireButton: "Consultar sobre Riu House",
  whatsappMessage:
