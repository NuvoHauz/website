...
À l'extérieur, les voyageurs peuvent se détendre parmi les jardins tropicaux, profiter des terrasses couvertes et utiliser la piscine partagée avec les deux cabanes voisines de NuvoHauz. Riu House offre un cadre paisible pour ceux qui recherchent confort, intimité et un lien plus proche avec la nature du Costa Rica.`,
  amenities: [
    ...
    "Télévisions dans toutes les chambres",
    "Grande télévision dans le salon",
    "Cuisine entièrement équipée",
    "Réfrigérateur",
    "Micro-ondes",
    "Ustensiles, vaisselle, verres et couverts",
    "Îlot central avec sièges",
    "Salle à manger intérieure",
    "Terrasses et balcons privés",
    "Piscine partagée",
    "Lave-linge et sèche-linge partagés",
    "Douche extérieure",
    "Jardins tropicaux",
    "Vues sur la rivière et le paysage tropical",
    "Une place de stationnement désignée",
  ...
  houseRules: [
    ...
    "Les visiteurs extérieurs nécessitent l'approbation préalable de l'hôte",
    "Les visiteurs ne peuvent pas passer la nuit sauf s'ils sont ajoutés à la réservation",
    "Les invités non enregistrés pour la nuit sont interdits",
    "L'occupation approuvée de la propriété ne doit pas être dépassée",
    "La piscine et la buanderie sont partagées avec les deux cabanes voisines",
  ],
  arrival:
