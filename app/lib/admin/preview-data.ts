...
export function getPreviewReservations(owner: OwnerName): AdminReservationsResponse {
  ...
  const bookingRequests = bookingRows.map((row) =>
    mapBookingRequest({
      ...
      pricing_nights_count: null,
      pricing_nightly_subtotal_cents: null,
      pricing_cleaning_fee_cents: null,
      pricing_estimated_total_cents: null,
      pricing_nightly_breakdown: null,
